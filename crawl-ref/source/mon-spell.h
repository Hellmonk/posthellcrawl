...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_DEEP_ELF_KNIGHT,
      {
       { SPELL_STONE_ARROW, 36, MON_SPELL_WIZARD },
    ...
    {  MST_ORC_HIGH_PRIEST,
      {
       { SPELL_SMITING, 15, MON_SPELL_PRIEST },
    ...
    {  MST_GLOWING_ORANGE_BRAIN,
      {
       { SPELL_BRAIN_FEED, 13, MON_SPELL_MAGICAL },
       { SPELL_SHADOW_CREATURES, 13, MON_SPELL_MAGICAL },
       { SPELL_MASS_CONFUSION, 13, MON_SPELL_MAGICAL },
       { SPELL_BLINK, 13, MON_SPELL_MAGICAL },
      }
    },
    ...
    {  MST_NAGA_MAGE,
      {
       ...
       { SPELL_DIMENSION_ANCHOR, 19, MON_SPELL_WIZARD  },
       { SPELL_HASTE, 19, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_NAGA_RITUALIST,
      {
       ...
       { SPELL_SUMMON_MANA_VIPER, 34, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_OGRE_MAGE_I,
      {
       { SPELL_HASTE_OTHER, 17, MON_SPELL_WIZARD },
       { SPELL_SLOW, 17, MON_SPELL_WIZARD },
    ...
    {  MST_OGRE_MAGE_II,
      {
       ...
       { SPELL_PARALYSE, 17, MON_SPELL_WIZARD },
       { SPELL_PHASE_SHIFT, 18, MON_SPELL_WIZARD },
      }
    },

    {  MST_OGRE_MAGE_III,
      {
       { SPELL_BOLT_OF_FIRE, 14, MON_SPELL_WIZARD },
       { SPELL_BOLT_OF_COLD, 14, MON_SPELL_WIZARD },
       { SPELL_LEHUDIBS_CRYSTAL_SPEAR, 14, MON_SPELL_WIZARD },
