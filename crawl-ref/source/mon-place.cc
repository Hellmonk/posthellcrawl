...
static const map<monster_type, band_set> bands_by_leader = {
    ...
    { MONS_NAGA_RITUALIST,  { {}, {{ BAND_NAGA_RITUALIST, {1, 4} }}}},
...
static const map<band_type, vector<member_possibilites>> band_membership = {
    ...
    { BAND_GNOLLS,              {{{MONS_GNOLL, 2},
                                  {MONS_GNOLL_HALBERDIER, 1}}}},
    ...
    { BAND_ORC_KNIGHT,          {{{MONS_ORC_WARRIOR, 9},
                                  {MONS_ORC_LANCER, 9},
                                  {MONS_WARG, 2},
                                  {MONS_ORC_WIZARD, 2},
                                  {MONS_ORC_PRIEST, 2},
                                  ...
                                  {MONS_TROLL, 1},
                                  {MONS_ORC_SORCERER, 1}}}},
    { BAND_OGRE_MAGE,           {{{MONS_OGRE_ENCHANTER, 1}},
                                 {{MONS_OGRE_PHILOSOPHER, 1}},
                                 {{MONS_TWO_HEADED_OGRE, 2},
                                  {MONS_OGRE, 1}}}},
    { BAND_OGRE_MAGE_EXTERN,    {{{MONS_OGRE_MAGE, 1}},
                                 {{MONS_OGRE_ENCHANTER, 1}},
                                 {{MONS_OGRE_PHILOSOPHER, 1}},
    ...
    { BAND_GUARDIAN_SERPENT,    {{{MONS_NAGA_MAGE, 5}, {MONS_RAINBOW_BOA, 10}},
                                 ...
                                 {{MONS_SALAMANDER, 3}, {MONS_SPITTING_COBRA, 12}}}},
    { BAND_NAGA_RITUALIST,      {{{MONS_BLACK_MAMBA, 9},
                                  {MONS_SPITTING_COBRA, 4},
                                  {MONS_MANA_VIPER, 4},
                                  {MONS_RAINBOW_BOA, 4},
                                  {MONS_ANACONDA, 4}}}},
