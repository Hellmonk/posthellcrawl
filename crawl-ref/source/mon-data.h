...
// AXED_MON(MONS_MOTHER_IN_LAW)
    ...
    AXED_MON(MONS_UNSEEN_HORROR)
    AXED_MON(MONS_BAI_SUZHEN)
    AXED_MON(MONS_BAI_SUZHEN_DRAGON)
    AXED_MON(MONS_NAGA_WARRIOR)
    AXED_MON(MONS_SWAMP_DRAKE)
    AXED_MON(MONS_ALLIGATOR_SNAPPING_TURTLE)
    AXED_MON(MONS_SHADOW)
    AXED_MON(MONS_PORCUPINE)
    AXED_MON(MONS_IRONHEART_PRESERVER)
#endif
...
// centaurs ('c')
{
    ...
    4, 220,
    3, 7, MST_ARCHER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_CENTAUR,
...

{
    ...
    10, 550,
    4, 8, MST_ARCHER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_CENTAUR,
...

{
    ...
    8, 440,
    4, 4, MST_ARCHER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_BIG, MON_SHAPE_CENTAUR,
...

{
    ...
    14, 770,
    5, 5, MST_ARCHER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_BIG, MON_SHAPE_CENTAUR,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    2, 10, MST_FAUN_I, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 750,
    0, 15, MST_ARCHER, CE_CLEAN, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 405,
    2, 11, MST_DEEP_ELF_MAGE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_VULN, 37}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    29, 1100,
...
{
    MONS_GNOLL_HALBERDIER, 'g', GREEN, "gnoll halberdier",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 10,
...
{ // a dummy monster for recolouring
    ...
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_QUADRUPED,
...
{
    MONS_SPRIGGAN_ASSASSIN, 'i', MAGENTA, "spriggan assassin",
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 440,
    2, 20, MST_CURARE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SPRIGGAN_ASSASSIN}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_ANTIMAGIC, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 540,
...
// merfolk ('m')
{
    ...
    { {AT_HIT, AF_REACH, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
...

{
    ...
    { {AT_HIT, AF_REACH, 37}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 780,
...
{
    MONS_MERFOLK_JAVELINEER, 'm', WHITE, "merfolk hunter",
    M_WARM_BLOOD | M_ARCHER | M_DONT_MELEE | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 60,
    { {AT_HIT, AF_REACH, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 780,
    0, 14, MST_ARCHER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_REACH, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 405,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 150,
    3, 12, MST_ORC_WIZARD_I, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_ORC_LANCER, 'o', BROWN, "orc lancer",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    16, MONS_ORC, MONS_ORC, MH_NATURAL, 20,
    { {AT_HIT, AF_REACH, 22}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 280,
    8, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORC_LANCER}, TILE_ERROR
},
...
{
    MONS_ORC_SNIPER, 'o', LIGHTBLUE, "orc sniper",
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    9, MONS_ORC, MONS_ORC, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 655,
    10, 10, MST_ARCHER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORC_KNIGHT}, TILE_ERROR
},

{
    ...
    { {AT_HIT, AF_PLAIN, 38}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1125,
    13, 8, MST_BATTLECRY, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    10, 650,
    9, 8, MST_HELL_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 33}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 800,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 400,
    2, 13, MST_NECROMANCER_I, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 400,
    2, 13, MST_WIZARD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_ENCHANTER, 'p', BLUE, "enchanter",
    M_SPEAKS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL | MH_EVIL, 60,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 400,
    2, 13, MST_ENCHANTER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ENCHANTER}, TILE_ERROR
},
...

{
    ...
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 60,
    { {AT_HIT, AF_VULN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 750,
...
{
    MONS_PHASE_BUG, 's', ETC_WARP, "phase bug",
    M_NO_SKELETON | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_GIANT_COCKROACH, MONS_PHASE_BUG, MH_NATURAL, 0,
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 30,
    1, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT,
    {TILEP_MONS_PHASE_BUG}, TILE_ERROR
},
...
DUMMY(MONS_CROCODILE, 't', BROWN, "crocodile", TILEP_MONS_CROCODILE)
...

{
    ...
    M_NO_SKELETON | M_SEE_INVIS,
    MR_NO_FLAGS,
    13, MONS_CRAB, MONS_APOCALYPSE_CRAB, MH_DEMONIC, 40,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, {AT_STING, AF_POISON, 12}, AT_NO_ATK, AT_NO_ATK },
    7, 245,
    2, 14, MST_MELIAI, CE_NOXIOUS, S_BUZZ,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_INSECT_WINGED,
...
// corporeal (semi-)humanoid undead ('z')
{
    ...
    { {AT_HIT, AF_DRAIN_XP, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 165,
...

{
    ...
    14, 700,
    24, 7, MST_ANCIENT_CHAMPION_I, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// angelic beings ('A')
{
    ...
    { {AT_HIT, AF_HOLY, 28}, {AT_HIT, AF_HOLY, 14}, AT_NO_ATK,
       AT_NO_ATK },
    12, 1020,
...

{
    ...
    { {AT_HIT, AF_HOLY, 18}, {AT_CHERUB, AF_HOLY, 11}, AT_NO_ATK,
       AT_NO_ATK },
    9, 765,
...

{
    ...
    { {AT_HIT, AF_HOLY, 55}, {AT_HIT, AF_FIRE, 25}, AT_NO_ATK,
       AT_NO_ATK },
    25, 2125,
...

{
    ...
    { {AT_HIT, AF_HOLY, 25}, {AT_HIT, AF_HOLY, 10}, AT_NO_ATK,
       AT_NO_ATK },
    14, 1190,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 495,
    5, 3, MST_ROCKS, CE_CLEAN, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_FIRE, 36}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 960,
...

{
    ...
    { {AT_HIT, AF_COLD, 36}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1040,
...

{
    ...
    16, 880,
    12, 2, MST_ROCKS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 39}, {AT_GORE, AF_PLAIN, 24}, AT_NO_ATK, AT_NO_ATK },
    13, 715,
...
{
    MONS_KOBOLD_ASSASSIN, 'K', GREEN, "kobold assassin",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_KOBOLD, MONS_KOBOLD, MH_NATURAL, 0,
    { {AT_HIT, AF_DRAIN_XP, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 95,
    2, 12, MST_CURARE, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_KOBOLD_ASSASSIN}, TILE_CORPSE_KOBOLD
},
...
// liches ('L')
{
    ...
    20, 800,
    10, 10, MST_LICH_I, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    27, 1080,
    20, 10, MST_LICH_II, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1950,
    10, 6, MST_GREATER_MUMMY, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// nagas ('N')
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_CONSTRICT, AF_CRUSH, 3},
       AT_NO_ATK, AT_NO_ATK },
    5, 275,
    8, 10, MST_NAGA, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK, AT_NO_ATK },
    7, 385,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_CONSTRICT, AF_CRUSH, 5}, AT_NO_ATK, AT_NO_ATK },
    9, 720,
    8, 10, MST_NAGA_SHARPSHOOTER, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    MR_NO_FLAGS,
    14, MONS_NAGA, MONS_NAGA, MH_NATURAL, 60,
    { {AT_HIT, AF_POISON, 18}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK, AT_NO_ATK },
    8, 600,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    3, 7, MST_OGRE_MAGE_III, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
{
    MONS_OGRE_ENCHANTER, 'O', LIGHTGREEN, "ogre enchanter",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    16, MONS_OGRE, MONS_OGRE, MH_NATURAL | MH_EVIL, 80,
    { {AT_HIT, AF_PLAIN, 34}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    3, 7, MST_OGRE_MAGE_II, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_OGRE_ENCHANTER}, TILE_ERROR
},

{
    MONS_OGRE_PHILOSOPHER, 'O', LIGHTCYAN, "ogre philosopher",
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    16, MONS_OGRE, MONS_TWO_HEADED_OGRE, MH_NATURAL | MH_EVIL, 80,
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    3, 7, MST_OGRE_MAGE_I, CE_CLEAN, S_SHOUT2,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_OGRE_PHILOSOPHER}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, {AT_PECK, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
       AT_NO_ATK },
    7, 315,
    2, 17, MST_TENGU_CONJURER_I, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_PECK, AF_PLAIN, 12}, {AT_CLAW, AF_PLAIN, 12},
       AT_NO_ATK },
    10, 600,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 31}, {AT_PECK, AF_PLAIN, 15}, {AT_CLAW, AF_PLAIN, 15},
       AT_NO_ATK },
    17, 850,
    2, 17, MST_TENGU_REAVER_I, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// spiritual beings ('R')
{
    ...
    { {AT_HIT, AF_FIRE, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
...
{
    MONS_RAINBOW_BOA, 'S', CYAN, "rainbow boa",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    10, MONS_SNAKE, MONS_RAINBOW_BOA, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 32}, {AT_CONSTRICT, AF_CRUSH, 6},
       AT_NO_ATK, AT_NO_ATK },
    11, 700,
    12, 10, MST_NO_SPELLS, CE_NOXIOUS, S_HISS,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_SNAKE,
    {TILEP_MONS_RAINBOW_BOA}, TILE_ERROR
},

{
    MONS_SPITTING_COBRA, 'S', YELLOW, "spitting cobra",
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    14, MONS_SNAKE, MONS_BLACK_MAMBA, MH_NATURAL, 20,
    { {AT_BITE, AF_PARALYSE, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 500,
    6, 15, MST_NAGA, CE_NOXIOUS, S_HISS,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE,
    {TILEP_MONS_SPITTING_COBRA}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 37}, {AT_BITE, AF_VAMPIRIC, 19}, AT_NO_ATK,
       AT_NO_ATK },
    11, 715,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, {AT_BITE, AF_VAMPIRIC, 18}, AT_NO_ATK,
       AT_NO_ATK },
    10, 550,
...
{
    MONS_GUARDIAN_GOLEM, '8', LIGHTGREEN, "ambulatory bomb",
    M_NO_EXP_GAIN,
    MR_NO_FLAGS,
    ...
    0, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_HUMANOID,
...
// statues and statue-like things (also '8')
{
    ...
    M_STATIONARY | M_NO_REGEN,
    mrd(MR_RES_COLD, 3) | MR_RES_PETRIFY,
    10, MONS_STATUE, MONS_ICE_STATUE, MH_NONLIVING, MAG_IMMUNE,
    { {AT_TOUCH, AF_COLD, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 100,
    4, 1, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...

{
    ...
    mrd(MR_RES_ELEC, 3) | MR_RES_PETRIFY,
...

{
    ...
    mrd(MR_RES_COLD | MR_RES_FIRE | MR_RES_ELEC, 3)
...
// "A"ngels.
{
    ...
    { {AT_HIT, AF_HOLY, 33}, {AT_HIT, AF_HOLY, 23}, AT_NO_ATK,
       AT_NO_ATK },
    19, 1520,
...

{
    ...
    { {AT_HIT, AF_COLD, 80}, {AT_HIT, AF_COLD, 35}, AT_NO_ATK, AT_NO_ATK },
    22, 6820,
...

{
    ...
    { {AT_HIT, AF_REACH, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 160,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 10,
    { {AT_HIT, AF_CHAOTIC, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 215,
    2, 9, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// "H"ybrids.
{
    ...
    { {AT_HIT, AF_POISON, 33}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    17, 2040,
    3, 10, MST_ARACHNE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_ARACHNID,
...

{
    ...
    { {AT_HIT, AF_PAIN, 40}, {AT_GORE, AF_PLAIN, 24}, AT_NO_ATK, AT_NO_ATK },
    15, 1275,
...

{
    ...
    15, 975,
    9, 28, MST_THE_ENCHANTRESS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...
// "K"obolds.
{
    ...
    { {AT_HIT, AF_DRAIN_XP, 11}, {AT_HIT, AF_POISON, 7}, {AT_HIT, AF_POISON, 7},
       AT_NO_ATK },
    6, 300,
...
// "m"erfolk.
{
    ...
    { {AT_HIT, AF_REACH, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1520,
...
// "O"gres.
{
    ...
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 540,
    3, 7, MST_WIZARD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
// "o"rcs.
{
    MONS_BLORK_THE_ORC, 'o', ETC_IRON, "Blork the orc",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 31}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 675,
...

{
    ...
    { {AT_HIT, AF_DRAIN_XP, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 600,
...
{
    MONS_SAINT_ROKA, 'o', ETC_GOLD, "Saint Roka",
...
// Tengu.
{
    ...
    { {AT_HIT, AF_ELEC, 34}, {AT_PECK, AF_PLAIN, 16}, {AT_CLAW, AF_PLAIN, 16},
       AT_NO_ATK },
    20, 1500,
...

{
    ...
    { {AT_HIT, AF_PAIN, 33}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1440,
...
// "V"ampires.
{
    ...
    { {AT_HIT, AF_PLAIN, 45}, {AT_BITE, AF_VAMPIRIC, 20}, AT_NO_ATK,
       AT_NO_ATK },
    18, 1800,
...
// Snails and other gastropods.
{
    ...
    MONUSE_OPEN_DOORS, SIZE_BIG, MON_SHAPE_SNAIL,
...

{
    ...
    // a spellbook, so MONUSE_OPEN_DOORS is necessary.
...
// human uniques
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 200,
    5, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    1, 95,
    2, 10, MST_JESSICA, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_REACH, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 300,
    2, 11, MST_ORC_WIZARD_II, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 440,
    6, 9, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_CHAOTIC, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 400,
    2, 12, MST_ORC_WIZARD_III, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 840,
    11, 9, MST_DONALD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 660,
    4, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_FIRE, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 630,
    2, 11, MST_ERICA, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_DRAIN_XP, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
    2, 10, MST_JOSEPHINE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 765,
    9, 8, MST_HAROLD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_DISTORT, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 1040,
    7, 9, MST_LOUISE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 31}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 1575,
    10, 10, MST_FREDERICK, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_FIRE, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    22, 1650,
    12, 10, MST_MARGERY, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_ELEC, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1890,
    4, 9, MST_NIKOLA, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_FIRE, 69}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 6510,
